...
import BannierConnecte from '../assets/connexion-reseau.png';
...
const Acceuil = () => {
  return (
    <div className="font-sans antialiased">
      {/* Hero Section */}
      <section className="relative min-h-[400px] md:min-h-[630px] flex items-center justify-center overflow-hidden">
        {/* Video Background */}
        <video
          autoPlay
          loop
        ...
        {/* Content */}
        <div className="relative z-30 text-white text-center py-20 px-4">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">Bienvenue à<br />ICC ONLINE.</h1>
      ...
      <section className="flex flex-col md:flex-row items-center justify-center py-16 px-4 bg-gray-100">
        <div className="w-full flex flex-col items-center md:w-1/2 text-left px-20 mb-8 md:mb-0 md:pr-8">
          <h2 className="text-3xl font-bold mb-4">Une famille connectée</h2>
        ...
        <div className="md:w-1/2 flex justify-center">
          ...
          <div className="w-64 h-64  rounded-full flex items-center justify-center text-gray-600">
            <img src={BannierConnecte} alt="Illustration" className="w-48 h-48 sm:w-64 sm:h-64 object-contain" />
          </div>
        </div>
      </section>

      {/* Join Online Impact Family Section */}<section className="relative w-full min-h-[400px] md:min-h-[630px] flex items-center justify-center text-white px-4 overflow-hidden">
        <img src={banniere} alt="Bannière" className="absolute inset-0 w-full h-full object-cover" />
        <div className="absolute inset-0 bg-black opacity-50"></div>
        <div className="relative z-10 w-full max-w-3xl text-center md:text-left px-4">
