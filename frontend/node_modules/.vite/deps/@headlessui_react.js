        ...
        if (!resetPlacement) {
          switch (fallbackStrategy) {
            case "bestFit": {
              ...
              const placement2 = (_overflowsData$map$so = overflowsData.map((d14) => [d14.placement, d14.overflows.filter((overflow2) => overflow2 > 0).reduce((acc, overflow2) => acc + overflow2, 0)]).sort((a27, b11) => a27[1] - b11[1])[0]) == null ? void 0 : _overflowsData$map$so[0];
              if (placement2) {
